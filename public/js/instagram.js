...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        _getHdUrl: function _getHdUrl(item) {
        ...
        getPopup: function getPopup() {
            ...
            if ($.type(self.$popup) == 'undefined') {
                ...
                */
                ...
                // @note CIPEHR.CO.TH
                '<div class="cps multiproduct-modal modal fade" tabindex="-1" role="dialog">', '<div class="modal-dialog">', '<div class="modal-content">', '<div class="modal-body">', '<div class="multiproduct-view">', '<div class="multiproduct-view-inner">', '<div class="row menu-row">', '<button type="button" class="close" data-dismiss="modal" aria-label="Back"><span', ' aria-hidden="true">&lt;</span></button>', '<label data-dismiss="modal">Store</label>', '</div>', '<div class="row no-inner-gutter container-row">', '<div class="multiproduct-photo-container col-xs-12 col-sm-7">', '<div class="squared-product-details-image-div">', '<div class="spatial-tag-container photo-tags-wrapper">', '', '</div>', '</div>', '</div>', '<div id="multiproduct-list" class="col-xs-12 col-sm-5 multiproduct-product-list">', '<div class="modal-header">', '<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span', ' aria-hidden="true">&times;</span></button>', '<h3 class="modal-title">Items to Shop</h3>', '</div>', '<div class="multiproduct-products">', '', '</div>', '</div>', '</div>', '<div class="row menu-row footer">', '', '</div>', '</div>', '</div>', '</div>', '</div><!-- /.modal-content -->', '</div><!-- /.modal-dialog -->', '</div><!-- /.modal -->'].join('');

                self.$popup = $(tpl).appendTo('body').find('.footer').text($('.app-container footer').text()).end();
        ...
        showPopup: function showPopup(item) {
            ...
            var image = new Image();
            var procContainer = function procContainer() {
            ...
            var procTagPos = function procTagPos($el, pos) {
                var width = image.width;
                var height = image.height;
            ...
            $popup.one('shown.bs.modal', function () {
                ...
                image.onload = function (evt) {
                    ...
                    $.each(item.points, function (key, pos) {
                        var $el = $(['<div class="photo-tags-tag">', '<span>' + pos.number + '</span>', '</div>'].join('')).data('pos', pos).appendTo($tagContainer);
                    ...
                    // set preview
                    $.each(item.points, function (key, pos) {
                        var $el = $(['<div class="photo-tags-preview-item">', '<div class="squared-photo-div">', '</div>', '<a href="' + pos.url + '" class="photo-tags-name">', '<span class="photo-tags-name-text"></span>', '</a>', '<div class="photo-tags-tag">', '<span>' + pos.number + '<span>', '</div>', '</div>'].join('')).appendTo($productContainer);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {}, [_c('div', [(_vm.subtitle) ? _c('div', {
    ...
    return _c('div', {
      ...
      staticClass: "photo-card-box"
    }, [_c('div', {
      staticClass: "photo-card-box-inner"
    }, [_c('div', {
      ...
      style: ({
        'background-image': 'url(' + _vm.getHdUrl(item) + ')'
      })
    })])])])])
  }))]), _vm._v(" "), _c('div', {
    directives: [{
  ...
  }, [_c('div', [_c('div')]), _c('div', [_c('div')]), _c('div', [_c('div')]), _c('div', [_c('div')]), _c('div', [_c('div')]), _c('div', [_c('div')]), _c('div', [_c('div')]), _c('div', [_c('div')])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-27926188", module.exports)
  }
}
